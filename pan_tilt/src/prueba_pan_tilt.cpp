...
int main(int argc, char** argv)
{
  ...
  ros::Publisher flir_publisher;		//Declaramos los publicadores y subcriptores

  flir_publisher 	= n.advertise<sensor_msgs::JointState>("/joint_states", 1); 
