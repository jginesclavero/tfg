...
\begin{figure}[H]
  \begin{center}
    \subfigure[]{\includegraphics[width=5cm,height=5cm]{img/cap5/incrementmap}}
    \subfigure[]{\includegraphics[width=5cm,height=5cm]{img/cap5/incrementmap2}}
    \subfigure[]{\includegraphics[width=5cm,height=5cm]{img/cap5/incrementmap-rviz}}
  \end{center}
