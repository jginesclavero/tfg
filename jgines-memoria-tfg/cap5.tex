...
\begin{figure}[hbtp]
  \begin{center}
    \subfigure[Mapa total]{\includegraphics[width=12cm,height=7cm]{img/cap5/map-ext}}
    \subfigure[Mapa de largo plazo]{\includegraphics[width=12cm,height=7cm]{img/cap5/longmap-ext}}
    \subfigure[Mapa de corto plazo]{\includegraphics[width=12cm,height=7cm]{img/cap5/shortmap-ext}}
  \end{center}
